...
//import dev.langchain4j.community.store.embedding.neo4j.HypotheticalQuestionRetriever;
//import dev.langchain4j.community.store.embedding.neo4j.Neo4jEmbeddingStore;
//import dev.langchain4j.community.store.embedding.neo4j.ParentChildGraphRetriever;
//import dev.langchain4j.community.store.embedding.neo4j.SummaryRetriever;
...
//import static dev.langchain4j.community.store.embedding.neo4j.ParentChildGraphRetriever.DEFAULT_RETRIEVAL;
//import static dev.langchain4j.community.store.embedding.neo4j.ParentChildGraphRetriever.PARENT_QUERY;
...
//        final SummaryRetriever retriever = SummaryRetriever.builder()
//                .driver(driver)
...
//
//    @Test
//    public void testParentChildRetriever_withDocumentByRegexSplitterAndCustomEmbeddingStore() {
//        EmbeddingModel embeddingModel = new AllMiniLmL6V2QuantizedEmbeddingModel();
//
//
//        final Neo4jEmbeddingStore store = Neo4jEmbeddingStore.builder()
//                .driver(driver)
...
//                """;
//        // Index the document into Neo4j as parent-child nodes
//        HypotheticalQuestionRetriever retriever = HypotheticalQuestionRetriever.builder()
//                .embeddingModel(embeddingModel)
//                .driver(driver)
//                .maxResults(2)
//                .minScore(0.5)
...
//                .promptAnswer(DEFAULT_PROMPT_ANSWER)
//                .build();
//
...
//
//    @Test
//    void testIndexHypotheticalQuestions_withDocumentBySentenceSplitter() {
//        // Step 1: Document with metadata
//        Document parentDoc = Document.from(
//                """
//                Quantum mechanics studies how particles behave. It is a fundamental theory in physics.
